...
/**
 * This class creates a HeartBroken object that implements the Extra class.
 * This object increases the stressbar once it collides with the human.
 * 
 * @author Mikee Jazmines, Alyssa Ty
 * @version May 18, 2016
 */
public class BrokenHeart implements Extra {
	private int x, y, width, height;
	private int fallSpeed, value;
	Random rand = new Random(); // creates random number 	
	private StressBar sb;
	private CircleTest c;
	private ImageIcon bh; 
	 ...
	 */
	public BrokenHeart (StressBar b, CircleTest ct)  {
	 ...
	 * @param v Value
	 */
	public BrokenHeart (StressBar b, CircleTest ct, int num, int speed, int v)  {
		x = num;
		value = v;
		fallSpeed = speed;
		y=120;
	...
	/**
	 * 
	 * This method draws the icon of BrokenHeart.
	 * 
	 * @param g2d Accepts a Graphics2D parameter
	 */
	public void draw(Graphics2D g2d){
			bh = new ImageIcon ("heart_ver1.png");
			bh.paintIcon(mf,g2d,x,y);
	}
