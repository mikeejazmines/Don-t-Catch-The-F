...
public class Beer implements Extra {
	 ...
	 */
	public Beer(StressBar b, CircleTest ct)  {
	 ...
	 * @param v Value
	 */
	public Beer(StressBar b, CircleTest ct, int num, int speed, int v)  {
		x = num;
		value = v;
		fallSpeed = speed;
		y=120;
	...
	/**
	 * 
	 * This method draws the icon of Beer.
	 * 
	 * @param g2d Accepts a Graphics2D parameter
	 */
	public void draw(Graphics2D g2d){
			drink = new ImageIcon ("ber_ver2.png");
			drink.paintIcon(mf,g2d,x,y);
	}
